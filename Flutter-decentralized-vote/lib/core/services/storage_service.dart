...
class LocalStorageService {
  ...
  static Future<void> setAiCopilotEnabled(bool v) =>
      _box.write(_aiCopilotKey, v);

  static bool get aiTranscriptionEnabled =>
      _box.read<bool>(_aiTranscriptionKey) ?? true;
  static Future<void> setAiTranscriptionEnabled(bool v) =>
      _box.write(_aiTranscriptionKey, v);

  static bool get aiCoachingEnabled => _box.read<bool>(_aiCoachingKey) ?? false;
  static Future<void> setAiCoachingEnabled(bool v) =>
      _box.write(_aiCoachingKey, v);

  static bool get aiVoiceAssistantEnabled =>
      _box.read<bool>(_aiVoiceAssistantKey) ?? true;
  static Future<void> setAiVoiceAssistantEnabled(bool v) =>
      _box.write(_aiVoiceAssistantKey, v);

  // Notifications
  static bool get notificationsEnabled =>
      _box.read<bool>(_notificationsKey) ?? true;
  static Future<void> setNotificationsEnabled(bool v) =>
      _box.write(_notificationsKey, v);

  // Meeting Defaults
  static bool get cameraOnByDefault => _box.read<bool>(_cameraOnKey) ?? true;
  static Future<void> setCameraOnByDefault(bool v) =>
      _box.write(_cameraOnKey, v);
  ...
  static Future<void> setAutoRecordEnabled(bool v) =>
      _box.write(_autoRecordKey, v);
}
