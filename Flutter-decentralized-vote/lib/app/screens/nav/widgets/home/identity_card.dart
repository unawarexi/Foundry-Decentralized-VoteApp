        ...
        child: AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: TColors.secondary.withOpacity(0.22 + 0.1 * pulseAnim.value),
                width: 1,
              ),
              boxShadow: [
                BoxShadow(
            ...
            child: Column(
              ...
              children: [
                ...
                const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    CardDetailChip(label: 'POLLING UNIT', value: '002-UGBOWO', mono: true),
                    CardDetailChip(label: 'BLOCKCHAIN HASH', value: '0x8B...F2A', mono: true),
                  ],
                ),
                const SizedBox(height: 20),
                const Row(
                  children: [
                    StatusPill(icon: Icons.verified_user_rounded, label: 'KYC Verified', active: true),
                    SizedBox(width: 8),
                    StatusPill(icon: Icons.link_rounded, label: 'On-Chain', active: true),
                  ],
                ),
              ],
            ),
