...
import 'package:flutter_frontend_vote/presentation/screens/analytics_screen.dart';
import 'package:flutter_frontend_vote/presentation/screens/candidates_screen.dart';
import 'package:flutter_frontend_vote/presentation/screens/profile_screen.dart';
import 'package:flutter_frontend_vote/presentation/screens/verify_screen.dart';
import 'package:flutter_frontend_vote/presentation/screens/vote_screen.dart';
...
class _BottomNavigationState extends State<BottomNavigation>
  ...
  final List<NavItem> _navItems = [
    ...
    NavItem(
      ...
      label: 'Profile',
      gradientColors: [TColors.defi, TColors.blockchain],
    ),
    NavItem(
      icon: Icons.verified_outlined,
      activeIcon: Icons.verified,
      label: 'Verify',
      gradientColors: [TColors.blockchain, TColors.primaryBlue],
    ),
  ];
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? [
                    TColors.darkCard,
                    TColors.darkSurface.withOpacity(0.95),
                    TColors.darkBackground.withOpacity(0.9),
                  ]
                : [
                    Colors.white,
                    TColors.lightSurface.withOpacity(0.95),
                    TColors.lightBackground.withOpacity(0.9),
                  ],
          ),
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: !isActive
                          ? (isDark
                                ? TColors.darkBackground.withOpacity(0.3)
                  ...
                  AnimatedDefaultTextStyle(
                    ...
                    style: TextStyle(
                      ...
                      color: isActive
                          ? (isDark ? TColors.white : TColors.primaryBlue)
                          : (isDark
                                ? TColors.textDarkSecondary
                                : Colors.grey[600]),
